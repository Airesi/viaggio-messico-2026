        ...
        },
        {
            ...
            days: [
                ...
                },
                {
                    ...
                    title: "Cascate, Mosaici di Pietra e Mezcal",
                    location: "Valle dell'Est (Hierve el Agua & Mitla)",
                    shortDesc: "Tour fuori porta tra bellezze naturali uniche, antiche rovine geometriche e le distillerie tradizionali di mezcal.",
                    fullDesc: "<p>Oggi noleggiamo un'auto o partecipiamo a un tour condiviso verso est. Prima tappa: l'incredibile <strong>Árbol del Tule</strong>, un enorme e millenario cipresso di Montezuma dal tronco più largo del mondo. Proseguiamo verso <strong>Mitla</strong>, il secondo sito archeologico più importante, unico per i complessi e affascinanti mosaici geometrici che adornano i suoi palazzi.</p><p>Il pezzo forte naturalistico è <strong>Hierve el Agua</strong>: spettacolari cascate pietrificate affacciate su una gola vertiginosa. Chi vorrà potrà tuffarsi nelle piscine naturali sulfuree in cima (l'acqua è fresca!). Sulla via del ritorno a Oaxaca, chiudiamo la giornata fermandoci in un <em>palenque</em>, una distilleria rustica, per scoprire come l'agave si trasforma nel puro e pungente <strong>Mezcal artigianale</strong>.</p>",
                    images: ["https://images.unsplash.com/photo-1577903792019-90b501d7fa74?auto=format&fit=crop&w=400&q=80"],
                    links: [
                        { text: "🔗 Guida a Hierve el Agua", url: "https://ecobnb.it/blog/2021/11/hierve-el-agua-cascate-pietrificate-messico/" }
                    ],
                    route: [
